    ...
    public void postConstruct()
    {
        if(em.find(Employee.class, 1l) == null)
        {
            ...
            **/
            ...
            Reservation reservationB = new Reservation(new Date(), new Date(121, 10, 12), new Date(121, 10, 14), 11, BigDecimal.valueOf(100), false, false);
            ...
            Reservation reservationD = new Reservation(new Date(), new Date(121, 10, 12), new Date(121, 10, 14), 6, BigDecimal.valueOf(100), false, false);
